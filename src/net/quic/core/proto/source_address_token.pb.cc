...
void InitDefaultsSourceAddressTokenImpl() {
  ...
  protobuf_cached_5fnetwork_5fparameters_2eproto::InitDefaultsCachedNetworkParameters();
  {
...
void InitDefaultsSourceAddressToken() {
  ...
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsSourceAddressTokenImpl);
}
...
void InitDefaultsSourceAddressTokensImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_source_5faddress_5ftoken_2eproto::InitDefaultsSourceAddressToken();
  {
...
void InitDefaultsSourceAddressTokens() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsSourceAddressTokensImpl);
}
...
SourceAddressTokens::SourceAddressTokens()
  : ::google::protobuf::MessageLite(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_source_5faddress_5ftoken_2eproto::InitDefaultsSourceAddressTokens();
  }
  SharedCtor();
